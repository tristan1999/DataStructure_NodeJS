...
console.log("Player1:"+player1+"   排序後: " +player1.sort(compare));
console.log("Player2:"+player2+"   排序後: " +player2.sort(compare));
console.log("Player3:"+player3+"   排序後: " +player3.sort(compare));
console.log("Player4:"+player4+"   排序後: " +player4.sort(compare));
